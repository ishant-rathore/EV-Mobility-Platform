...
## Integrated Modules 01–03 journey evaluation
...
`traffic` block on each demo route. The traffic block includes current/predicted loads and classes,
source provenance, selected horizon, travel-time multiplier, and vehicle eligibility. Clients do
not send trusted battery capacity or efficiency to this endpoint.
