...
- Completed Module 12 with one validated demo-control API and a fully wired React control center.
- Added process-local reset, traffic overrides, charger charging/fault/restore, vehicle batches, source-mode fallback reporting, and screenshot freeze/resume.
