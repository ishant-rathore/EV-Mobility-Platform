...
export const diversificationVehicleClassSchema = z.enum([
  "CAR",
  "BIKE",
  "TRUCK",
  "COMMERCIAL",
...
export const diversifyRoutesSchema = z.object({
  ...
  vehicleClass: diversificationVehicleClassSchema,
...
export const resetDemoSchema = z.object({
  ...
  simulationId: z.string().trim().min(1).max(100).optional(),
});
