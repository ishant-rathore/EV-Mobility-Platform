...
export interface TrafficSegment extends TrafficPredictionInput {
  name: string;
  capacity: number;
  currentLoad: number;
...
export function predictTrafficForRoute(segments: TrafficPredictionInput[], method: PredictionMethod = "rule-based"): TrafficPredictionResult[] {
